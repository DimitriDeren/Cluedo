...
/**
 * models.Player class to handle all player actions and track position and known clues
 */
public class Player {
    ...
    /**
     * Initialise models.Player object
     ...
     * @return models.Item refuteCard - item object to refute with
     */
    public Item refute(ArrayList<Item> suggestion, int otherName) {
        ...
        if (!Collections.disjoint(suggestion, this.cards)) {
            ...
            System.out.println("models.Player " + name + " - Please select a card to refute " + otherName + "'s suggestion (select relevant number): ");
